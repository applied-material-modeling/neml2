...
#
# Axis paths for common variables:
#   forces/*      — external driving (strain rate, temperature, time)
#   state/*       — internal state (hardening, damage, plastic strain)
#   parameters/*  — model parameters exposed as outputs
#
...
[Drivers]
  [unit]
    ...
    input_Scalar_names = 'forces/input_name'
    ...
    # input_SR2_names = 'forces/strain'
    # input_SR2_values = 'E'

    # --- Scalar outputs ---
    output_Scalar_names = 'state/output_name'
