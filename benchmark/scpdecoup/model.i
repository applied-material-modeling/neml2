...
[Models]
  ...
  # value, mirroring tests/regression/.../single_crystal_decoupled/.
  ############################################################################
  [euler_rodrigues_1]
    type = RotationMatrix
    from = 'orientation~1'
...
[Models]
  ############################################################################
  # Sub-system #2: implicit update of orientation using THIS step's
  # elastic_strain + slip_hardening (produced by subsystem1). The dependency
  # resolver wires subsystem1's outputs to subsystem2's inputs automatically.
  ############################################################################
  [euler_rodrigues_2]
    type = RotationMatrix
    from = 'orientation'
