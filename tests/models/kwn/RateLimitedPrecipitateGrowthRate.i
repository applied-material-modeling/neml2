# Translated from tests/unit/models/kwn/RateLimitedPrecipitateGrowthRate.i.
[Drivers]
  [unit]
    type = ModelUnitTest
    model = 'model'
...
[Tensors]
  ...
  [x_inf]
    type = Python
    expr = "Scalar(torch.tensor(0.25))"
  []
  [R_dot]
    type = Python
    expr = "Scalar(torch.tensor([0.42857142857142855, 0.21428571428571427, 0.10714285714285714]), sub_batch_ndim=1)"
  []
[]
