# Translated from tests/unit/models/solid_mechanics/viscoelasticity/BurgersElement.i.
[Drivers]
  [unit]
    type = ModelUnitTest
    model = 'model'
...
[Tensors]
  ...
  [S]
    type = Python
    expr = 'SR2.fill(7, -3.5, -3.5, 1.4, -0.7, 0.35)'
  []
  # EvM_dot = S / etaM = S / 200
  [EvM_dot]
    type = Python
    expr = 'SR2.fill(0.035, -0.0175, -0.0175, 0.007, -0.0035, 0.00175)'
  []
  ...
  [EK_dot]
    type = Python
    expr = 'SR2.fill(0.065, -0.0325, -0.0325, 0.013, -0.0065, 0.00325)'
  []
[]
