# neml2
# Native port of tests/verification/finite_volume/advection-diffusion/advection-diffusion.i.
# Combined advection + diffusion of a Gaussian pulse; the final profile is
# compared against the analytical advected/diffused Gaussian (with numerical
# diffusion folded into D_eff via D_eff = D + |v|*dx/2).
D = 0.01
v = 0.5
l = -0.0
