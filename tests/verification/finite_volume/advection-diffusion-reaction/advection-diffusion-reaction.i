# neml2
# Native port of tests/verification/finite_volume/advection-diffusion-reaction/advection-diffusion-reaction.i.
# Combined advection + diffusion + first-order reaction of a Gaussian pulse;
# the final profile is compared against the analytical advected/diffused/decayed
# Gaussian.
D = 0.01
v = 0.5
l = -0.1
