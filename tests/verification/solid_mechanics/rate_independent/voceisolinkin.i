# neml2
# Native port of tests/verification/solid_mechanics/rate_independent/voceisolinkin.i.
# Rate-independent J2 plasticity with Voce isotropic + linear kinematic
# hardening solved by an FB-complementarity return map. Reference time /
# strain / stress trajectories come from voceisolinkin.csv (converted from
# the original .vtest by scripts/vtest_to_csv.py).
[Tensors]
  [times]
    type = CSVScalar
    csv_file = 'voceisolinkin.csv'
    variable = 'time'
  []
  [strains]
    type = CSVSR2
