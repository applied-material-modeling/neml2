# neml2
# Native port of tests/verification/solid_mechanics/traction_separation_law/bilinear_pure_shear/bilinear_pure_shear.i.
# Verification of CamanhoDavila/BilinearTraction under pure-shear loading with delta_n = 0
# throughout. Exercises the compression-branch energy identity 0.5 * S * delta_final = GIIc.
