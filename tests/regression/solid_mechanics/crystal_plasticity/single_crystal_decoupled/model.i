# neml2
# Single-crystal decoupled crystal plasticity scenario, native port of
# tests/regression/solid_mechanics/crystal_plasticity/single_crystal_decoupled/model.i.
# Two sequentially-solved sub-systems: (1) elastic strain + slip hardening,
# (2) orientation. Dynamic batch axis = (20,) (varying end-time / initial
# orientation across the batch); no per-slip sub-batch.
[Tensors]
