...
[Models]
  ...
  [implicit_rate_1]
    type = ComposedModel
    models = 'euler_rodrigues elasticity resolved_shear elastic_stretch plastic_deformation_rate
              sum_slip_rates slip_rule slip_strength voce_hardening integrate_slip_hardening
              integrate_elastic_strain'
  []
[]
...
[Models]
  ...
  [subsystem2]
    type = ComposedModel
    models = 'euler_rodrigues elasticity resolved_shear plastic_deformation_rate plastic_spin
