# neml2
# Single-crystal decoupled-implicit/explicit orientation scenario, native port
# of tests/regression/solid_mechanics/crystal_plasticity/
# single_crystal_decoupled_explicit_orientation/model.i. Sub-system #1 solves
# elastic_strain + slip_hardening implicitly using the LAGGED orientation
# (orientation~1) for the RotationMatrix; sub-system #2 then integrates
# orientation explicitly via WR2ExplicitExponentialTimeIntegration using the
# freshly-updated elastic_strain. Dynamic batch axis = (20,).
[Tensors]
...
[Models]
  ...
  # elastic_strain from sub-system #1.
  ############################################################################
  [orientation_rate]
