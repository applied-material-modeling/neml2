...
[Models]
  ...
  [implicit_rate]
    type = ComposedModel
    models = 'kinharden mandel_stress overstress vonmises yield_surface normality flow_rate
              Eprate Kprate Erate Eerate elasticity integrate_stress integrate_Kp'
  []
[]
...
[Models]
  ...
  [pred_path]
    type = ComposedModel
    models = 'Erate Eprate Eerate elasticity pp_stress Kprate pp_Kp kinharden mandel_stress
  ...
  [pred_seed]
    ...
    cold = 'stress:stress_cd kinematic_plastic_strain:kinematic_plastic_strain_cd'
  []
  [predictor]
    type = ComposedModel
    models = 'pt_stress_rate pt_stress pt_mandel pt_kinharden pt_overstress pt_vonmises pt_yield
              pt_normality Erate Eprate Eerate elasticity Kprate pred_coupling pred_cd ps_stress
              ps_Kp pred_seed'
  []
  [model]
    type = ImplicitUpdate
