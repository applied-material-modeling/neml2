...
Crystal plasticity in NEML2 is built around an incremental, rate-form view of single-crystal kinematics: a forward operator that, given the current spatial velocity gradient, integrates the elastic stretch, the lattice orientation, and any internal hardening variables forward in time. The catalog under
`neml2/models/solid_mechanics/crystal_plasticity/` carves this physics into reusable primitives — kinematic operators ([](models-ElasticStrainRate), [](models-OrientationRate), [](models-PlasticDeformationRate), [](models-PlasticVorticity), [](models-PlasticSpatialVelocityGradient)), constitutive maps from stress to resolved shear ([](models-ResolvedShear)) and from internal state to slip strength ([](models-SingleSlipStrengthMap), [](models-DislocationObstacleStrengthMap)), slip kinetics ([](models-PowerLawSlipRule)), and hardening laws ([](models-LinearSingleSlipHardeningRule), [](models-VoceSingleSlipHardeningRule), [](models-PerSlipForestDislocationEvolution)). The crystal geometry itself (slip systems, twin systems) is generated by an ancillary [](data-CubicCrystal) data object, so users specify Miller indices, not enumerated slip systems.
