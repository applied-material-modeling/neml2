...
NEML2 is extensible by design. When the built-in model library
doesn't cover what you need, you can add your own as a small Python
class derived from `Model`, plug it into an input file like any
registered type, and optionally compile it to AOT-Inductor for
