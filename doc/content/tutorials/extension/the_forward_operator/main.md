...
```cpp
options.add_optional<bool>("define_values") = true;
options.add_optional<bool>("define_derivatives") = true;
options.add_optional<bool>("define_second_derivatives") = false;
```
