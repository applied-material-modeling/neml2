...
The earlier tutorials focus on evaluating a model — given parameters
and inputs, compute outputs. The other major use case is
*calibration*: given input/output observations, find the parameters
that best fit them.
