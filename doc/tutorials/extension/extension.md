...
- \f$\eqref{1}\f$ can be defined using [VecVariableRate]{#vecvariablerate}.
- \f$\eqref{2}\f$ is not available in NEML2, and is the focus of this set of tutorials. We will name it as `ProjectileVelocity`.
- \f$\eqref{3}\f$ can be defined using [VecBackwardEulerTimeIntegration]{#vecbackwardeulertimeintegration}.
